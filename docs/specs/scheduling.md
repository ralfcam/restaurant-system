...
| CL-1                      | `validateOperatingDays(days, slotIntervalMinutes?)` — HH:MM, half-open `[opens, closes)`, opens-aligned grid; empty `bookable_slots` skipped; chrome `scheduling-slot-row` / `scheduling-slot-time` — `lib/reservations/operating-hours.ts`, `components/staff/scheduling-manager.tsx`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `tests/unit/scheduling/cover-limits.test.ts` → "accepts on-grid service slots and rejects off-grid or outside-window times"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
