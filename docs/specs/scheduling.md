...
19. **FP-15 — Seated bill total on the chip** — When the overlay status is
    ...
    **FP-15-COMPLETE** — The snapshot MUST include every matching order, not
    ...
    per-`table_label` sum that cannot truncate line items). **FP-15-UNAVAILABLE**
