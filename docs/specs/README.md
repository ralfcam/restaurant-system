...
| [dev-toolchain.md](./dev-toolchain.md)                     | Draft  | Dev gates: G-T1 typecheck, G-L1 lint (`eslint.config.mjs`; gitignored supabase CLI temp/branches in `globalIgnores`; unused-disable directives error), G-F1 Prettier (`format` / `format:check`; snapshot trees prettierignored) |
