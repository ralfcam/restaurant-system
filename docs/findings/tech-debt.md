...
- [ ] Privilege forward filename still hours-only · `supabase/migrations/20260825140000_operating_windows_privilege.sql` · file now also GRANTs `blocked_dates` / `reservations` / `menu_items`; renaming a dated migration is unsafe · low · (found: tdd/reazed-297_sibling_grants_097b94f3/C1/green)
