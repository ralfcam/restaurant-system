...
const SURFACE_FILES = [
  ...
  "components/staff/menu-manager.tsx",
] as const

describe("menu manager surface catalogs", () => {
  it("renders menu page and menu manager copy from next-intl catalogs with no hard-coded system copy", () => {
