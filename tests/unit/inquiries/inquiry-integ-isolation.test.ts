...
const INTEG_GLOB = "tests/integration/inquiries/*.integ.test.ts"
...
function discoverInquiryIntegSuites(): string[] {
...
describe("inquiry integ isolation pin (EI-9)", () => {
  it("inquiries integ suites call assertIsolatedHoursMutationTarget before mutating writes", () => {
    const files = discoverInquiryIntegSuites()
