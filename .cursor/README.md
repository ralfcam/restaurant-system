...
Backlog without a cycle; `/dispatch` metadata-plans the full scoped Backlog
portfolio, then activates only the available slots in a 5–10 total-active
Todo/current-cycle queue.
